...
* Für wie lange wurden die Wildschweine beprobt? *Die Wildschweine wurden vom* `r min(wildschwein_BE$DatetimeUTC)` *bis * `r max(wildschwein_BE$DatetimeUTC)` *beprobt. Die Daten wurden gleichzeitig erhoben.*

* Was ist der zeitliche Intervall zwischen zwei Lokationen? *Der Intervall beträgt *`r round(mean(x = wildschwein_BE$timelag_num, na.rm = TRUE),0)` *Sekunden.*

```{r task 2, include=FALSE}
# Task 2     
