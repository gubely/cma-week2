...
# cowplot::plot_grid(p2, axis = 'l', align = 'h', ncol = 1, nrow = 1, scale = 0.6, greedy = FALSE)
# cowplot::plot_grid(p3, axis = 'l',ncol = 1, nrow = 1, scale = 0.6, greedy = FALSE)
# cowplot::plot_grid(p4, axis = 'l',ncol = 1, nrow = 1, scale = 0.6, greedy = FALSE)
```
